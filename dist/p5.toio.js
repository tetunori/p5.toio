...
let SimpleTileMat = (() => {
    ...
    SimpleTileMat.matrixMinX = 98;
    SimpleTileMat.matrixMinY = 142;
    SimpleTileMat.matrixMaxX = 402;
    SimpleTileMat.matrixMaxY = 358;
    SimpleTileMat.matrixRows = 5;
    SimpleTileMat.matrixColumns = 7;
    return SimpleTileMat;
})();
{ SimpleTileMat };
class StandardId {
